...
export const apartments: Apartment[] = [
  ...
  },
  {
    slug: "apartament-5",
    name: "Apartament 5",
    tagline: "Apartament compact de 45 mp, întreg al tău — cu aer condiționat",
    shortDescription:
    ...
    rating: 5.0,
    reviewsCount: 99,
    view: "Etaj 2 · 45 mp · Compact cu AC",
    amenities: [
      "Apartament întreg privat (nu cameră de hotel)",
